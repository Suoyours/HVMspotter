...
def train(train_loader, model, optimizer, epoch, start_iter, cfg):
    ...
    for iter, data in enumerate(train_loader):
        ...
        loss = loss_vertical + loss_horizontal
        ...
        if iter % 20 == 0:
            ...
            log = f'({iter + 1}/{length}) ' \
                  ...
                  f'Loss(vertical/horizontal/total{"/rec" if with_rec else ""}): ' \
                  f'{losses_vertical.avg:.3f}/{losses_horizontal.avg:.3f}/{losses.avg:.3f}/' \
                  f'{"/" + format(losses_rec.avg, ".3f") if with_rec else ""} | ' \
                  f'IoU(vertical/horizontal): {ious_vertical.avg:.3f}/{ious_horizontal.avg:.3f}' \
