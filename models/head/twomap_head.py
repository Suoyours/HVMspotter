...
class TwoMap_Head(nn.Module):
    ...
    def loss(self, out, gt_vertical, gt_horizontal, training_masks):
        # output
        vertical = out[:, 0, :, :]
        horizontal = out[:, 1, :, :]
